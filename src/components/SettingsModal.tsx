...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const handleThemeChange = (newTheme: 'light' | 'dark') => {
    const updated: AppPreferences = { ...preferences, theme: newTheme, mapTheme: newTheme };
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="bg-[#115e59] text-white px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-white/15 flex items-center justify-center border border-white/20">
              <Sliders className="w-5 h-5 text-teal-100" />
            </div>
            <div>
              <h2 className="text-base font-bold tracking-tight">Application Preferences</h2>
              <p className="text-xs text-teal-100/90">Personalize display mode, alerts, GPS precision & language</p>
            </div>
          </div>
          <button
            ...
            <div className="divide-y divide-slate-100 border border-slate-200 rounded-xl overflow-hidden bg-white">
              ...
              <div className="p-3.5 flex items-center justify-between hover:bg-slate-50/60 transition">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-900">App Language (भाषा)</p>
                    <p className="text-[11px] text-slate-500">
                      {preferences.language === 'hi' ? 'हिन्दी (Hindi) सक्रिय है' : 'English language enabled'}
                    </p>
                  </div>
                </div>
              ...
              <div className="p-3.5 flex items-center justify-between hover:bg-slate-50/60 transition">
                ...
                <button
                  ...
                  onClick={() => setPreferences(prev => {
                    const next = { ...prev, mapTheme: prev.mapTheme === 'light' ? 'dark' as const : 'light' as const };
              ...
              <div className="p-3.5 flex items-center justify-between hover:bg-slate-50/60 transition">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer ${
                    preferences.pushNotifications ? 'bg-[#115e59]' : 'bg-slate-300'
                  }`}
                >
                  <div
              ...
              <div className="p-3.5 flex items-center justify-between hover:bg-slate-50/60 transition">
                ...
                <button
                  ...
                  className={`w-11 h-6 flex items-center rounded-full p-1 transition-colors cursor-pointer ${
                    preferences.soundAlerts ? 'bg-[#115e59]' : 'bg-slate-300'
                  }`}
                >
                  <div
                    className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-200 flex items-center justify-end gap-2">
          ...
          <button
            ...
            type="button"
            onClick={handleSave}
            className="px-5 py-2 text-xs font-bold text-white bg-[#115e59] hover:bg-[#0f4f4b] rounded-xl shadow-xs transition flex items-center gap-1.5 cursor-pointer"
          >
